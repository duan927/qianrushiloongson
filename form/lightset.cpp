...
void lightset::paintEvent(QPaintEvent *event)
{
...
void lightset::setOtherBackgroud(bool status,QPainter *painter)
{
    if(status == true)
    {
        painter->save();
...
//绘制控件
void lightset::drawDashBoardWiget(QPainter *painter)
{
    //全局参数初始化
    qParmInit();
...
//绘制仪表盘
void lightset::drawDashBoard(QPainter *painter)
{
    painter->save();
...
void lightset::drawDivideRule(QPainter *painter)
{
    painter->save();
...
void lightset::drawDashBoardText(QPainter *painter)
{
    painter->save();
...
void lightset::drawDishBoardPointer(QPainter *painter)
{
    painter->save();
...
void lightset::setValue(float qValue)
{
    this->qValue = qValue;
    this->none=true;
}

void lightset::setValuenone()
{
    this->qValue = 0;
    this->none=false;
}

void lightset::setMaxValue(float fMaxValue)
{
    this->fMaxValue = fMaxValue;
}

void lightset::setDashBoardEdgeColor(QColor &qColor)
{
    qDialEdgeColor = qColor;
}

void lightset::setDashDivideBackgroudColor(QColor &qColor)
{
